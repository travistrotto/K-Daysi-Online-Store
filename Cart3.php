...
<br><br><br><br><h1>Customer Details</h1>
<form action="checkout.php" method="POST">
<font style="font-family: calibri;">
First and Last Name<br><input type="text" name="custName"><br><br>
Shipping Street Address<br><input type="text" name="address"><br><br>
Shipping City<br><input type="text" name="city"><br><br>
Shipping State<br>
...
<br><br>
Shipping ZIP Code<br><input type="text" name="zip"><br><br></font>
            <a href="checkout.php" style="position: right;">
                    <center>
                    <input type="submit" value="Check Out" style="background: #bc8bcf; border: 0px; border-radius: 8px; font-size: 13px; font-family: 'calibri'; color: white; width: 100px; padding: 0px 0px; text-align: center;">
                    </form>
                    </center>
                </a> 
