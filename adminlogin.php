...
<head>
    <meta charset="utf-8"/>
    <title>K-Daysi Admin Login</title>
...
if(isset($_SESSION['$adminUser']) != 'admin'){
    ...
    */
    ...
    if (isset($_POST['username'])) {
        ...
        $query    = "SELECT * FROM adminaccounts WHERE adminAccount='$username'
    ...
    <form class='form' method='post' name='login'>
        ...
        <center>
                  <h3><font style='font-family: calibri; font-size: 18px; color: black;'>Incorrect admin username or password.</font></h3><br/>
                  <p class='link'><font style='font-family: calibri; font-size: 16px; color: black;'>Click here to <a href='adminlogin.php'>Login</a> again.</font></p></center>
...
<div class="container" style="width: 65%">
    ...
    <form class="form" method="post" name="login">
        ...
        <center>
        <input type="text" class="login-input" name="username" placeholder="Admin Username" autofocus="true"/><br><br>
        <input type="password" class="login-input" name="password" placeholder="Admin Password"/><br><br>
